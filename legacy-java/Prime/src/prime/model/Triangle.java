...
public class Triangle implements Serializable {
  ...
  public RayTriHitInfo intersect(final Ray ray) {
    ...
    return new RayTriHitInfo(true, this, u, v);
  }
  ...
  public Vec3f interpolatePosition(float u, float v) {
    ...
    Vec3f v1 = getVertex(1);
    Vec3f v2 = getVertex(2);
    return new Vec3f(w * v0.x + u * v1.x + v * v2.x, w * v0.y + u * v1.y + v * v2.y, w * v0.z + u * v1.z + v * v2.z);
  }
  ...
  public static float getArea(Vec3f v0, Vec3f v1, Vec3f v2) {
    float dx1 = v1.x - v0.x, dy1 = v1.y - v0.y, dz1 = v1.z - v0.z, dx2 = v2.x - v0.x, dy2 = v2.y - v0.y, dz2 = v2.z
        - v0.z;
    float x = dy1 * dz2 - dz1 * dy2, y = dz1 * dx2 - dx1 * dz2, z = dx1 * dy2 - dy1 * dx2;
